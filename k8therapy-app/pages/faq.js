  ...
  return (
    <>
      <section className='faq-content'>
        <div className='faq-content__page-title'>
          <h1>Frequently Asked Questions</h1>
        </div>
        <section className='faq-content__question-container'>
          <div className='faq-content__question-block'>
            <span>What is counseling?</span>
            <p>
              In my opinion, counseling at its basic form is a commitment and
              investment in yourself or your relationship. It takes time, energy
              and costs money. Some parts will be fun, some uncomfortable. Most
              importantly I think of counseling as a process in which you are
              allowed to feel vulnerable and safe at the same time. You can heal
          ...
          <div className='faq-content__question-block'>
            <span>What is it like to be in counseling?</span>
            <p>
              Each of us are unique. We have led different lives, experienced
          ...
          <div className='faq-content__question-block'>
            <span>How does counseling work?</span>
            <p>
              Rarely are our minds calm and settled. We think about millions of
          ...
          <div className='faq-content__question-block'>
            <span>How often should I come to counseling?</span>
            <p>
              Most women and couples come to counseling once or twice a week
              depending on what is needed at the time. Clients in crisis can
              greatly benefit from coming in twice per week then reduce to one
              session per week once things settle.
            </p>
          </div>
          <div className='faq-content__question-block'>
            <span>Why do you want to work with women?</span>
            <p>
              When I first entered into the field of counseling, I purposefully
          ...
          <div className='faq-content__question-block'>
            <span>Why do you want to work with couples?</span>
            <p>
              Relationships when they are good have the power to lift both
              individuals up. There is nothing quite like feeling completely
              supported by another person whom you love and care about. But
              sometimes life, present or past, gets in the way of a happy
              relationship. Maybe you have never learned how to deal with
              conflicts or there is something getting in the way of connecting
