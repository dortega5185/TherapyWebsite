    ...
    <div>
      ...
      <section className='info-block'>
        <aside className='info-block__sm-body'>
          <h3>Some random text from the sewer</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse,
            beatae suscipit. Laboriosam omnis deleniti facilis vel quaerat
            voluptatem maxime dolores unde sint dicta? Sequi labore repudiandae
            consequuntur animi. In, eligendi.
          </p>
        </aside>
